...
public class TextMetaFile
{
    ...
    private Map<Integer, TextChar> metaData = new HashMap<Integer, TextChar>();
    ...
    private TextChar loadCharacter()
    {
        ...
        return new TextChar(id, xTex, yTex, xTexSize, yTexSize, xOff, yOff, quadWidth,
                quadHeight, xAdvance);
    }
    ...
    public void printData()
    {
        ...
        for(TextChar c : metaData.values())
        {
    ...
    public TextChar getCharacter(int ascii)
    {
