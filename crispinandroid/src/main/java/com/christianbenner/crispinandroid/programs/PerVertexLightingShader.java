...
public class PerVertexLightingShader extends ShaderProgram {
    // Uniform locations
    ...
    public PerVertexLightingShader(Context context) {
        super(context, R.raw.lighting_pervertex_vertex,
                R.raw.lighting_pervertex_frag);
